<?php
    ...
    $check1 = "select groupid from event7 where member1='$invoice1' or member2='$invoice1' or member3='$invoice1' or member4='$invoice1'";
    $res5 = mysqli_query($con, $check1);
    $row1 = mysqli_fetch_assoc($res1);
    $gp1 = $row1['groupid'];

    $check2 = "select groupid from event7 where member1='$invoice2' or member2='$invoice2' or member3='$invoice2' or member4='$invoice2'";
    $res6 = mysqli_query($con, $check2);
    $row6 = mysqli_fetch_assoc($res6);
    $gp2 = $row6['groupid'];
	
    $check3 = "select groupid from event7 where member1='$invoice3' or member2='$invoice3' or member3='$invoice3' or member4='$invoice3'";
    $res7 = mysqli_query($con, $check3);
    $row7 = mysqli_fetch_assoc($res7);
    $gp3 = $row7['groupid'];
	
    $check4 = "select groupid from event7 where member1='$invoice4' or member2='$invoice4' or member3='$invoice4' or member4='$invoice4'";
